...
// Registro de clientes — exclusivo del tenant "printmediapty" (Print Media
// PTY), no aplica a las demás empresas.
...
export async function POST(req: Request) {
  ...
  const requeridos = { nombreEmpresa, rucDv, nombreRepresentanteLegal, nombreContacto, telefono, correo, direccion }
